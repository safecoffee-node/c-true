/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 16f4daa8029fa861b5ea909adf0f6766)
// Runtime types generated with workerd@1.20260317.1 2026-03-22 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		quote_app_core_db: D1Database;
		ASSETS: Fetcher;
		AUTH_BASE_URL: string;
		APP_ENV: string;
		SVC_AUTH: Fetcher /* svc-auth */;
		SVC_COMMENT: Fetcher /* svc-comments */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_BASE_URL" | "APP_ENV">> {}
}
